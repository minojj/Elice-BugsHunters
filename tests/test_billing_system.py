...
def test_bu_004_click_ml_api(logged_in_driver):
    driver = logged_in_driver
    driver.get("https://qaproject.elice.io/cloud/usage")
    page = UsagePage(driver)
    page.click_ml_api_tab()
    assert page.is_ml_api_selected()

def test_bu_005_click_severless_status(logged_in_driver):
    driver = logged_in_driver
    driver.get("https://qaproject.elice.io/cloud/usage")
    page = UsagePage(driver)
...
def test_bu_006_click_api_key_manage(logged_in_driver):
    driver = logged_in_driver
    driver.get("https://qaproject.elice.io/cloud/usage")
    page = UsagePage(driver)
